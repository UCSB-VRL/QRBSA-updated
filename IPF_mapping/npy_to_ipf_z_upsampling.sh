...
current_dir=$(pwd)
modelname="reynolds_1layer_transpose_conv_256dim"
...
# #d3_sourceName (material_dream3dfile) = '/data/dkjangid/superresolution/Material_Dataset/Nickel/raw_data_hdf_files/Open_718_Test.dream3d'
