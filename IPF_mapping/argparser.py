...
class Argparser:
    ...
    def prepare_arg_parser(self):
        ...
        arg_parser.add_argument('--exp_type', type=str, default='min_angle_transform',
                                help='type of experiment')
        arg_parser.add_argument('--exp_dir_path', type=str, default='/data/home/umang/Materials/QRBSA-jan30-joaquin-edit/Quaternion_experiments/',
                                help='Path to the experiment directory')
        arg_parser.add_argument('--material_dream3dfile', type=str, default='/data/home/umang/Materials/Materials_data_mount/Open_718_Training.dream3d',
